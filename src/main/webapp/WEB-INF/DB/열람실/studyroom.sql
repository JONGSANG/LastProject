...
스케줄링 테스트용 쿼리
UPDATE STUDYROOM SET START_TIME=ADDTIME(START_TIME, '08:00:00') WHERE NUM='a01'
UPDATE STUDYROOM SET END_TIME='08:00:00' WHERE NUM='a01'
UPDATE STUDYROOM SET STATE=0, START_TIME=NULL, END_TIME=NULL, ID=NULL WHERE (TIMEDIFF(END_TIME, CURTIME()) < 0)
