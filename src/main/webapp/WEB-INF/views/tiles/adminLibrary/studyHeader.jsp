...
<div style="padding-top: 20px; padding-left: 160px">
<button class="roombtn" onclick="location.href='/adminLibrary/adminStudyRoom/aRoom/index'">제 1 열람실</button>&nbsp;&nbsp; 
<button class="roombtn" onclick="location.href='/adminLibrary/adminStudyRoom/bRoom/index'">제 2 열람실</button>&nbsp;&nbsp;
<button class="roombtn" onclick="location.href='/adminLibrary/adminStudyRoom/cRoom/index'">노트북 열람실</button>
</div>
