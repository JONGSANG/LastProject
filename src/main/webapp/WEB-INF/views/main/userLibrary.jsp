...
<div id="userLibrary">
				...
				<div id="tab1" class="tab_content">
					<table>
						<c:forEach items="${notice}" var="list" varStatus="var" end="4">
							<tr>
								<td valign="middle" id="#title" width="300px"><img
									src="/resources/images/fronticon.png" width="10px"
									style="padding-top: 5px"> <a
									href='/userLibrary/libNews/notice/read?num=${list.num}'>${list.title}</a>
								</td>
								<td valign="middle" id="#title2" align="center" width="100px"
									height="25px">${list.id}</td>
								<td valign="middle" id="#title3" align="center" width="100px"
									style="float: right;" height="25px"><fmt:formatDate
										value="${list.write_date}" pattern="yyyy-MM-dd" /></td>
							</tr>
						</c:forEach>
					</table>
				</div>
						...
						<c:forEach items="${f_board}" var="list" varStatus="var" end="4">
							<tr>
								<td valign="middle" id="#title" width="300px"><img
									src="/resources/images/fronticon.png" width="10px"
									style="padding-top: 5px"> <a
									href='/userLibrary/libNews/f_board/read?num=${list.num}'>${list.title}</a>
								</td>
								<td valign="middle" align="center" width="100px" height="25px">${list.id}</td>
						...
						<c:forEach items="${m_board}" var="list" varStatus="var" end="4">
							<tr>
								<td valign="middle" id="#title" width="300px"><img
									src="/resources/images/fronticon.png" width="10px"
									style="padding-top: 5px"> <a
									href='/userLibrary/service/min_board/read?num=${list.num}'>${list.title}</a>
								</td>
								<td valign="middle" align="center" width="100px" height="25px">${list.id}</td>
								<td valign="middle" align="center" width="100px"
									style="float: right;" height="25px"><fmt:formatDate
										value="${list.min_date}" pattern="yyyy-MM-dd" /></td>
							</tr>
						</c:forEach>
					</table>
				</div>
	...
	<div id="mainright">
		...
		<div id="s_banner_wrap">
			<ul class="bxslider">
				<a href="http://www.kosta.or.kr/"><div style="width: 256px; height: 100px; background: url('/resources/images/logoKosta.png'); "></div></a>
				<a href="http://www.snlib.go.kr/index.do"><div style="width: 256px; height: 100px; background: url('/resources/images/logoSeongnam.png');"></div></a>
				<a href="https://www.yonginlib.go.kr:5444/intro.asp"><div style="width: 256px; height: 100px; background: url('/resources/images/logoyongin.png');"></div></a>
