...
<table>
	...
	<tr>
		...
		<td><form action="/adminLibrary/adminService/code" method="get"><input type="hidden" name="bNo" value="${delivery.bNo}">
		<input type="text" name="rent_num" placeholder="13자리 숫자만 입력가능" maxlength="13" pattern="[0-9]{13}">
			<input type="submit" value="승인 및 배송">
			</form></td>
	</tr>
	</c:forEach>
</table>
...
<table>
	...
	<tr>
		...
		<td><a href="http://service.epost.go.kr/trace.RetrieveEmsTrace.postal?ems_gubun=E&POST_CODE=${deliverySuccesss.rent_num}" onClick="window.open(this.href, 'delivery', 'width=714, height=553, left=500, top=150'); return false;">${deliverySuccesss.rent_num}</a></td>
	</tr>
	</c:forEach>
</table>
