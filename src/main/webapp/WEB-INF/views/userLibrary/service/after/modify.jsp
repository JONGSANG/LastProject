...
<table border = "1">
	...
	<tr>
		<td>[ <select name = "aselect">
				<option value = "">카테고리</option>
				<option value = "맞고">맞고</option>
				<option value = "포커">포커</option>
				<option value = "고스톱">고스톱</option>
				<option value = "체스">체스</option>
			</select> ] - TITLE : <input type = "text" name = "title" value="${afterVO.title }"></td>
	</tr>
	<tr>
		<td>Max count : <input type = "text" name = "max_cnt" value = "${afterVO.max_cnt }"></td>
	</tr>
	<tr>
		<td>Content : <input type = "text" name = "content" value="${afterVO.content }"></td>
	</tr>
	<tr>
